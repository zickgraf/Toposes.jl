...
#! @Returns a morphism ⥉ $\mathrm[Hom]( \mathrm[TerminalObject], \Omega )$
#! @Arguments T, Omega
...
#! @Description
#! The arguments are an object $a$ && object $b$ which is equal to the power object $\mathrm[PowerObject](a)$.
